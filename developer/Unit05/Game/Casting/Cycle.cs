...
namespace Unit05.Game.Casting
{
    ...
    public class Cycle : Actor
    {
        ...
        /// <summary>
        /// Gets the Cycle segments (including the head).
        /// </summary>
        ...
        public override void MoveNext(){
            /// Add a new at the beginning the list (the head)
            Actor oldHead = GetHead();

            /// Update the old head to be the # character now
            oldHead.SetText("#");


            /// Add this in the direction tht the Cycle is moving.
